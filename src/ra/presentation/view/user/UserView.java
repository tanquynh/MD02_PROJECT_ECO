...
import ra.presentation.view.admin.MyAccount;
...
import static ra.business.constant.Constant.ProductStatus.HIDE;
...
public class UserView {
    ...
    public void displayUserMenu() {
        ...
        do {
            ...
            System.out.println(".-------------------------------------------------------------.");
            System.out.println("| WELCOME USER : " + userDesign.userActive().getUserName() + "                                        |");
            System.out.println("|-------------------------------------------------------------|");
            ...
            System.out.println("|                 8. DANH SÁCH YÊU THÍCH                      |");
            System.out.println("|                 9. GIỎ HÀNG                                 |");
            System.out.println("|                 10. MY PROFILE                               |");
            System.out.println("|                 11. NHẮN TIN                                |");
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    List<Product> productList = productDesign.findAll();
                ...
                case 5:
                    ...
                    break;
                case 6:
                    List<Product> products = productDesign.findAll();
                    addToCart(products);
                    break;
                case 7:
                    addToWishList();
                    break;
                case 8:
                    new WishlistView().displayMenuWishlist();
                    break;
                case 9:
...
//        System.out.println("|" + "   1. MỚI NHẤT          |    2. MUA NHIỀU        |    3. YÊU THÍCH        |    0. QUAY LẠI         " + "|");
        ...
        switch (InputMethods.getInteger()) {
            case 1:
                List<Product> latestProducts = productDesign.findAll()
                        .stream()
            ...
            case 2:
                ...
                List<Order> orderList = orderDesign.findAll();
                ...
                for (Order order : orderList) {
                    for (Cart cart : userDesign.findById(order.getIdUser()).getCart()) {
    ...
    public void addToCart(List<Product> products) {
        ...
        Cart cart = new Cart();
        cart.setProduct(productDesign.findById(productId));
        cart.setCartId(cartDesign.autoId());
        ...
        while (true) {
            ...
            } else if (count > productDesign.findById(productId).getStock()) {
    ...
    private void searchProduct() {
        ...
        List<Product> products = productDesign.getSearchProduct();
        displayProductList(products);
    ...
    private void sortProduct() {
        ...
        switch (InputMethods.getInteger()) {
            case 1:
                List<Product> productList = productDesign.findAll().stream().sorted((p1, p2) -> (int) -(p1.getPrice() - p2.getPrice())).collect(Collectors.toList());
                displayProductList(productList);
                break;
            case 2:
                List<Product> products = productDesign.findAll().stream().sorted((p1, p2) -> (int) (p1.getPrice() - p2.getPrice())).collect(Collectors.toList());
                displayProductList(products);
                break;
            case 0:
                return;
    ...
    private void likeCommentWishlistAndBuy() {
        ...
        Product product = productDesign.findById(idProductDetail);
        if (product == null) {
            return;
        }
    ...
    public void addToWishList() {
        ...
        wishList.setProduct(productDesign.findById(productId));
        wishList.setWishListId(wishlistDesign.autoId());
        // Lưu đối tượng Cart vào giỏ hàng
